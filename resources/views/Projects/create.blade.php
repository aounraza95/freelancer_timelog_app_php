	...
	<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
		...
		<div class="overflow-hidden bg-white shadow sm:rounded-lg">
			<div class="px-4 py-5 sm:px-6">
				<h3 class="text-xl font-semibold leading-6 text-gray-900">Create Project</h3>
				<p class="mt-1 max-w-2xl text-sm text-gray-500">Create new project here.</p>
			</div>
			<form method="POST" action="/projects/create/submit">
				<div class="border-t border-gray-200">
					<div class="p-5">
						<div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
							...
							<div class="sm:col-span-3">
								...
								<div class="mt-2">
									<input type="text" name="project_name" id="project_name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 p-2" autocomplete="off">
								</div>
							</div>
					...
					<div class="p-6 flex items-center justify-end gap-x-6">
						...
						<button type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save Project</button>
					</div>
				</div>
			</form>
		</div>
